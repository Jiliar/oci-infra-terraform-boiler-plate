...
# Cluster ID from dev infrastructure
cluster_id = "ocid1.cluster.oc1.sa-bogota-1.aaaaaaaayzacl6pbhbd7ymujuhdxxw44ywuqnjjklfs6ez4nmcmscnow7i4a"

# Istio Configuration
istio_version                    = "1.20.0"
enable_gateway                   = true
gateway_name                     = "addon-ai-test-gateway"
gateway_namespace                = "default"
gateway_hosts                    = ["test.addon-ai.com"]
enable_virtualservice            = true
virtualservice_name              = "addon-ai-test-vs"
virtualservice_namespace         = "default"
virtualservice_hosts             = ["test.addon-ai.com"]
virtualservice_destination_host  = "addon-ai-test-service"
...
tls_secret_name                  = "test-addon-ai-tls"  # Cert-Manager creará este secret