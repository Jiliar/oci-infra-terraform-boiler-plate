...
enable_gateway                   = true
gateway_name                     = "addon-ai-staging-gateway"
gateway_namespace                = "default"
gateway_hosts                    = ["staging.addon-ai.com"]
enable_virtualservice            = true
virtualservice_name              = "addon-ai-staging-vs"
virtualservice_namespace         = "default"
virtualservice_hosts             = ["staging.addon-ai.com"]
virtualservice_destination_host  = "addon-ai-staging-service"
...
tls_secret_name                  = "staging-addon-ai-tls"  # Cert-Manager creará este secret